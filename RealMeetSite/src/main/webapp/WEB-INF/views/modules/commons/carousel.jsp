		...
		<div id="myCarousel2" class="carousel slide vertical">
			...
			<div class="carousel-inner" role="listbox">
				<c:forEach var="e" items="${list}" varStatus="status">
					...
					<div class="item${numone}">
						<img alt="${status.count}위" src="${pageContext.request.contextPath}/resources/core/images/upload/${e.getImgsrc()}" data-src="holder.js/1200x500/text:slide">
