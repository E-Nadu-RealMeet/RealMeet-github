...
<script src="${pageContext.request.contextPath}/resources/core/js/bootstrap.min.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/core/css/main.css" />
>>>>>>> 1e2607ffd17b0693c352fb17314e484f51d67908
					...
					<tr>
						<td><form method="post" action="Notices">
								<div class="6u" align="center">
									<input style="margin-left: 50%; padding: 0.5em 1.0em 0.5em 1.0em;" type="text" name="title" placeholder="제목" /> <input
										style="margin-left: 50%; padding: 0.25em 1.0em 0.25em 1.0em;" type="submit" value="검색" />
								</div>
							</form></td>
						<td><a href="${pageContext.request.contextPath}/customer/customer"><input
								style="padding: 0.25em 1.0em 0.25em 1.0em; margin-left: -100%" type="submit" value="뒤로" /></a></td>
					</tr>
				</table>
			</div>
		</div>
						...
						<div class="12u$" style="">
							<table>
								<tr>
									...
									<td><a href="${pageContext.request.contextPath}/customer/customer"><input style="padding: 0.25em 1.0em 0.25em 1.0em;"
											type="submit" value="뒤로" /></a></td>
								</tr>
							</table>
						</div>
					</div>
