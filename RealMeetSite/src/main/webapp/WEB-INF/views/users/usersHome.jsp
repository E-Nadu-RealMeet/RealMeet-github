...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="container left">
		<div style="margin: 0 auto;">
			<div class="event_make"
				style="float: left; width: 100%; text-align: center; border: 0.5px solid #cccccc; margin: 1%; padding: 0 0.5em 0 0.5em;">
	...
	<div class="container right">
		<div class="event_join"
			style="float: right;width: 100%; text-align: center; border: 0.5px solid #cccccc; margin: 1%; padding: 0 0.5em 0 0.5em;">
