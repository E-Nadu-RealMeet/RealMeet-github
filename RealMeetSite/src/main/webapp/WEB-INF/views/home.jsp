						...
						<div class="container">
							...
							<div class="row">
								<div class="4u 12u$(mobile)">
									...
									<article class="item">
										<a href="#" class="image fit"><img src="${pageContext.request.contextPath}/resources/core/images/pic03.jpg" alt="" /></a>
										<header>
								...
								<div class="4u 12u$(mobile)">
									<article class="item">
										<a href="#" class="image fit"><img src="${pageContext.request.contextPath}/resources/core/images/pic04.jpg" alt="" /></a>
										<header>
											<h3>Magna Nullam</h3>
										</header>
									</article>
									<article class="item">
										<a href="#" class="image fit"><img src="${pageContext.request.contextPath}/resources/core/images/pic05.jpg" alt="" /></a>
										<header>
											<h3>Natoque Vitae</h3>
										</header>
									</article>
								...
								<div class="4u$ 12u$(mobile)">
									<article class="item">
										<a href="#" class="image fit"><img src="${pageContext.request.contextPath}/resources/core/images/pic06.jpg" alt="" /></a>
										<header>
											<h3>Dolor Penatibus</h3>
										</header>
									</article>
									<article class="item">
										<a href="#" class="image fit"><img src="${pageContext.request.contextPath}/resources/core/images/pic07.jpg" alt="" /></a>
										<header>
				...
				<!-- About Me -->
					<section id="about" class="three">
						<div class="container">
							...
							<a href="#" class="image featured"><img src="${pageContext.request.contextPath}/resources/core/images/pic08.jpg" alt="" /></a>
